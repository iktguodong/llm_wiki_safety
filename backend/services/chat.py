        ...
        messages = [
            {
                "role": "system",
                "content": ChatService._merge_system_prompt(
                    "你是一个专业的企业生产安全知识库问答助手。若提供了联网检索结果，请结合知识库与联网信息作答，不要编造。只聚焦企业生产安全、职业健康、应急处置、事故预防、隐患排查治理和现场安全管理；不要扩展到信息安全、网络安全、数据保护、个人隐私、合规、法务、财务或其他企业管理领域。你的回答要始终简洁高效，直奔主题，一针见血。",
                    assistant_prompt
                )
            },
            *history_messages,
